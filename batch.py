...
def upload_file_to_container(block_blob_client, container_name, file_stream):
    """
    ...
    tasks.
    """
    blob_name = file_stream.filename

    print('Uploading file {} to container [{}]...'.format(file_stream,
                                                          container_name))

    block_blob_client.create_blob_from_stream(container_name,
                                              blob_name,
                                              file_stream)
    ...
    sas_url = block_blob_client.make_blob_url(container_name,
                                              ...
                                              sas_token=sas_token)
    # pdb.set_trace()
    return batchmodels.ResourceFile(blob_source=sas_url, file_path=blob_name)
